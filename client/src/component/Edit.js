...
const Edit = () => {
   ...
   const {updata, setUPdata} = useContext(updatedata)
    ...
    const getdata = async () => {
        ...
        const res = await fetch(`https://crudappmernstack.herokuapp.com/getuser/${id}`, {
            method: "GET",
            headers: {
    ...
    const updateuser = async(e)=>{
        ...
        const res2 = await fetch(`https://crudappmernstack.herokuapp.com/updateuser/${id}`,{
            method: "PATCH",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    return (
        <div className="container">
            <NavLink to="/" className="btn btn-primary mt-2">Back to Home<ArrowBackIcon/></NavLink>
            <form className="mt-4">
                <div className="row">
